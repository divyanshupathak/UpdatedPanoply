				...
				<div className="tp-banner">
					<ul>
					{
						dataArr.map((value, index) => {
							...
							if(value.published){
								return(
									<li key={index} data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-thumb={img ? img.url() :''} data-saveperformance="off" data-title="">
	                    ...
	                    data-endelementdelay="0.3"
	                    data-endspeed="1200"
	                    data-endeasing="Power4.easeIn"><a href={value && value.linkUrl ? value.linkUrl :''} className="white-btn">{value && value.linkUrl ? value.linkTitle :''}</a>
	                  </div>
									</li>
								);
							}else{
